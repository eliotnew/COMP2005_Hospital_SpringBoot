...
/* Using the apache http client , google gson and the class "Admission" which is a class
based on the objects returned from the get request this class's constructor returns the day with the most admissions.
 */

public class FindBusiestDay {

    public String findBusiestDay() {
