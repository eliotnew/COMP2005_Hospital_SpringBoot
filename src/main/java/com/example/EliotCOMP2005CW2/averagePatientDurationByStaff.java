...
public class averagePatientDurationByStaff {
    private static final String API_URL_Allocations = "https://web.socem.plymouth.ac.uk/COMP2005/api/Allocations";
    private static final String API_URL_Admissions = "https://web.socem.plymouth.ac.uk/COMP2005/api/Admissions";
